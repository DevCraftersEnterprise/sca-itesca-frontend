  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <header class="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-30">
      <div class="max-w-screen-xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
        ...
        <!-- Izquierda: logo + saludo + badge rol -->
        <div class="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <!-- Saludo: texto corto en móvil, completo en desktop -->
        ...
        <!-- Derecha: cuenta + cerrar sesión -->
        <div class="flex items-center gap-1 flex-shrink-0">
          <!-- Cuenta: ícono solo en móvil, con texto en desktop -->
          <button
            @click="panelCuenta = true"
          ...
          <!-- Cerrar sesión: ícono solo en móvil, con texto en desktop -->
          <button
            @click="logout"
        ...
        >
          ...
          <div class="flex-1 overflow-y-auto px-6 py-6 space-y-6">
            ...
            <div class="flex flex-col items-center text-center gap-3">
              <!-- Avatar grande -->
              <div
                class="w-20 h-20 rounded-2xl flex items-center justify-center text-2xl font-bold text-white shadow-md"
                style="background: linear-gradient(135deg, #2B4EF0, #4B7BF5)"
              >
                {{ initiales }}
              </div>
            ...
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                ...
                <span class="text-xs text-gray-400">
                  Histórico: <span class="font-semibold text-gray-700">{{ usuario?.cursosHistorico ?? 0 }} cursos</span>
                </span>
              </div>
              ...
              <div class="bg-gray-50 rounded-xl p-4 space-y-3">
                <div class="flex items-end justify-between mb-1">
                  ...
                  <span class="text-sm font-bold"
                    :class="(usuario?.cursosAnio?.length ?? 0) >= META_ANUAL ? 'text-green-600' : 'text-gray-700'">
                  ...
                  <div
                    ...
                    :style="{
                      ...
                      background: (usuario?.cursosAnio?.length ?? 0) >= META_ANUAL
                        ...
                        : (usuario?.cursosAnio?.length ?? 0) > 0
                          ? 'linear-gradient(90deg,#F5C242,#fbbf24)'
                          : '#e5e7eb'
                    }"
                  ></div>
                </div>
              ...
              <div v-else class="space-y-2">
                ...
                >
                  ...
                  <!-- Estado chip -->
                  <span
                    class="shrink-0 text-[10px] font-bold px-2 py-0.5 rounded-full mt-0.5"
                    :class="c.estado === 'completado'
            ...
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                ...
                <button
                  @click="cambiarPass = !cambiarPass; passError = ''; passOk = false"
                ...
                <div v-if="cambiarPass" class="bg-gray-50 rounded-xl p-4 space-y-3">
                  ...
                  <div class="relative">
                    ...
                    <button
                      ...
                      class="absolute right-2.5 top-7 text-gray-400 hover:text-gray-600"
                    >
          ...
          <div class="px-6 py-4 border-t border-gray-100 shrink-0">
            <button
              @click="panelCuenta = false; logout()"
